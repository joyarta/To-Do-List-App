...
const Home = ({ navigation }) => {
  const { updateSelectedTask, deleteSelectedTask, todo } = apiDATA(
    (state) => ({
  ...
  return (
    <Fragment>
      {selectedTask !== null && (
        <Tugas {...{ setModalVisible, isModalVisible }}>
          <DateTimePicker
          ...
          <View style={styles.taskContainer}>
            ...
            <View style={{ flexDirection: 'row' }}>
              <View style={styles.readBook}>
                <Text style={{ textAlign: 'center', fontSize: 14, color: '#cfd0d1' }}>
                  Belajar
                </Text>
              </View>
              ...
              <View style={styles.learn}>
                <Text style={{ textAlign: 'center', fontSize: 14, color: '#cfd0d1' }}>Libur</Text>
              </View>
            </View>
      ...
      >
        <CalendarStrip
          ...
          calendarHeaderStyle={{ color: '#3895ff' }}
          dateNumberStyle={{ color: '#3895ff', paddingTop: 10 }}
          dateNameStyle={{ color: '#3895ff' }}
